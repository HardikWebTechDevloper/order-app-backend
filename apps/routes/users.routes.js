...
const { siginUserValidation, sendOTPValidation, createDistributorValidation, updateDistributorValidation, createStaffValidation, updateStaffValidation, deleteUser } = require('../validations/user.validation');
